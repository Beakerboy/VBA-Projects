...
'This function creates a square matrix from a vector
'The values in the vector lie in the diagonal of the new matrix
Dim Arr() As Variant
Dim R As Integer
...
'This Function creates the Vandermonde Matrix whose next to
...
'This function perfoms a weighted least squares fit of order lambda of x to y
...
'This function evaluates a polynomial at x where vector is an array of the polynomial coefficients
